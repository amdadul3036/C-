...
int main() {
    ...
    // cout << "Determine if an entered integer is between two other integers and assume lower < upper" << endl;
    ...
    cout << num  << " is on one of the bounds which are exactly "<< lower <<  " or " << upper << " : " << on_bounds << endl;
